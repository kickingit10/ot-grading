    ...
    <div className="min-h-screen" style={{ background: 'var(--color-bg)' }}>
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '32px 24px' }}>
        <div className="mb-6">
          ...
          <h1 style={{ fontSize: 28, fontWeight: 600, letterSpacing: '-0.02em', marginTop: 8, color: 'var(--color-text)' }}>Add student</h1>
          <p style={{ fontSize: 15, marginTop: 4, color: 'var(--color-text-muted)' }}>Create a profile to start tracking progress</p>
        </div>
